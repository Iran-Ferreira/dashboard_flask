...
class User(db.Model, UserMixin):
    ...
    date_creted = db.Column(db.DateTime(6), default=db.func.current_timestamp(), nullable=False)
...
disease_patient = db.Table("disease_patient", 
    ...
    db.Column("patient_id", db.Integer, db.ForeignKey("disease.id")),
)
...
class Patient(db.Model):
    ...
    last_state = db.Column(db.Date, onupdate=db.func.current_timestamp(), nullable=False)
